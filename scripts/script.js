...
const ANIMATION_SPEED = 240; // Hitrost v ms (manj je hitreje)

let lastEatTime = 0;                // Kdaj je bila nazadnje poedena pikica
const MOUTH_OPEN_DURATION = 80;    // Koliko ms naj bo slika zamenjana
// -----------------------------------------------------
